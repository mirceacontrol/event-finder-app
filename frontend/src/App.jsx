...
function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-100 to-blue-300 flex flex-col">
      {/* Floating Wishlist Button (demo only) */}
      <button
        className="fixed top-8 right-12 z-50 bg-yellow-100 text-yellow-800 font-bold px-6 py-3 rounded-xl shadow hover:bg-yellow-200 flex items-center gap-2"
      ...
      <div className="flex flex-1 justify-center items-center">
        <div className="bg-white rounded-3xl shadow-xl p-10 w-full max-w-2xl mt-12">
          ...
          <div className="flex justify-center mb-2">
            {/* SVG Ticket Icon (optional, for demo look) */}
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none"><path fill="#3066be" d="M21 5v2.764a1.236 1.236 0 010 2.472V13.5a1.5 1.5 0 01-1.5 1.5H4.5A1.5 1.5 0 013 13.5V10.236a1.236 1.236 0 010-2.472V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
          </div>
          <h1 className="text-3xl font-bold text-center text-black mb-2">Event Finder</h1>
          ...
          <div className="space-y-6 mt-5">
            {events.length === 0 && !loading && (
              <div className="text-gray-400 text-center text-lg">No events found. Try a search!</div>
            )}
            {events.map((ev, idx) => (
              <div
                key={idx}
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path fill="#194769" d="M21 5v2.764a1.236 1.236 0 010 2.472V13.5a1.5 1.5 0 01-1.5 1.5H4.5A1.5 1.5 0 013 13.5V10.236a1.236 1.236 0 010-2.472V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
                  <span className="text-xl font-bold text-blue-800">{ev.name}</span>
                </div>
                ...
                <div className="flex flex-row gap-4 mt-1">
                  ...
                  <button className="bg-blue-700 text-white rounded px-3 py-1 flex items-center gap-1 font-bold hover:bg-blue-800 transition">
                    <span role="img" aria-label="star">⭐</span>
                    Add to Wishlist
                  </button>
                </div>
